// spatial hash spatial-hash-grid.cu
// compile: nvcc -o spatial-hash-grid spatial-hash-grid.cu -lsfml-graphics -lsfml-window -lsfml-system
...
const int total_particles = 1000000;
